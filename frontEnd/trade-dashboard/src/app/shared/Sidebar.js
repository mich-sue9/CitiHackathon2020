          ...
          <li className="nav-item nav-profile">
            <a href="!#" className="nav-link" onClick={evt =>evt.preventDefault()}>
              ...
              <div className="nav-profile-text">
                ...
                <span className="text-secondary text-small"><Trans>Trader</Trans></span>
              </div>
          ...
          <li className={ this.isPathActive('/trade-form') ? 'nav-item active' : 'nav-item' }>
            ...
            <Collapse in={ this.state.tradeFormMenuOpen }>
              <ul className="nav flex-column sub-menu">
                ...
                <li className="nav-item"> <Link className={ this.isPathActive('/trade-form/tradehistory') ? 'nav-link active' : 'nav-link' } to="/trade-form/tradehistory"><Trans>Trade history</Trans></Link></li>
              </ul>
            </Collapse>
          </li>
